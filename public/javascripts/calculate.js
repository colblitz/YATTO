var BonusTypes = {
  ...
  SKILL_DRN_TDMG:             39,
  SKILL_DRN_OHKO:             40,
  HERO_DEATH_CHANCE:          41,
  HERO_REVIVE_TIME:           42, };

var Artifact = function(name, world, x, y, levelcap, effects, flavor) {
  this.name = name;
  this.world = world;
  this.x = x;
  this.y = y;
...
var artifact_info = {
  AOV:       new Artifact("Amulet of the Valrunes",  1, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  25, BonusTypes.GOLD_MOBS:               10}, ""),
  AXE:       new Artifact("Axe of Resolution",       1, 0.5, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_TDMG:          10}, ""),
  BM:        new Artifact("Barbarian's Mettle",      1, 0.4, 1.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_CDR_TDMG:          -5}, ""),
  BREW:      new Artifact("Brew of Absorption",      1, 0.6, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.TAP_DAMAGE_ARTIFACTS:     2}, ""),
  CHEST:     new Artifact("Chest of Contentment",    1, 1.0, 1.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  20, BonusTypes.CHEST_ARTIFACTS:         20}, ""),
  ELIXIR:    new Artifact("Crafter's Elixir",        1, 0.5, 1.8, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  20, BonusTypes.GOLD_OVERALL:            15}, ""), // gold while playing
  EGG:       new Artifact("Crown Egg",               1, 1.0, 1.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  20, BonusTypes.CHEST_CHANCE:            20}, ""),
  CLOAK:     new Artifact("Dark Cloak of Life",      1, 0.5, 2.0,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.BOSS_HEALTH:             -2}, ""),
  DS:        new Artifact("Death Seeker",            1, 0.8, 2.5,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.CRIT_CHANCE:             10}, ""),
  CHALICE:   new Artifact("Divine Chalice",          1, 0.7, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.GOLD_10X_CHANCE:        0.5}, ""),
  HAMMER:    new Artifact("Drunken Hammer",          1, 0.6, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.TAP_DAMAGE_ARTIFACTS:     2}, ""),
  FF:        new Artifact("Future's Fortune",        1, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.GOLD_ARTIFACTS:           5}, ""),
  HT:        new Artifact("Hero's Thrust",           1, 0.7, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   20}, ""),
  HO:        new Artifact("Hunter's Ointment",       1, 0.4, 1.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  60, BonusTypes.SKILL_CDR_HERO:          -5}, ""),
  KS:        new Artifact("Knight's Shield",         1, 0.7, 1.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.GOLD_BOSS:              100}, ""),
  LP:        new Artifact("Laborer's Pendant",       1, 0.7, 1.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_CDR_GOLD:          -5}, ""),
  GAUNTLET:  new Artifact("Ogre's Gauntlet",         1, 0.5, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_AUTO:          10}, ""),
  OA:        new Artifact("Otherworldly Armor",      1, 1.0, 2.2,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.HERO_DEATH_CHANCE:       -5}, ""),
  LOTION:    new Artifact("Overseer's Lotion",       1, 0.4, 1.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_CDR_AUTO:          -5}, ""),
  PARCHMENT: new Artifact("Parchment of Importance", 1, 0.5, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_CRIT:          10}, ""),
  ROO:       new Artifact("Ring of Opulence",        1, 0.7, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_GOLD:          10}, ""),
  ROWC:      new Artifact("Ring of Wondrous Charm",  1, 0.5, 1.7,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.UPGRADE_COST:            -2}, ""),
  SCROLL:    new Artifact("Sacred Scroll",           1, 0.4, 1.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_CDR_CRIT:          -5}, ""),
  SAINTLY:   new Artifact("Saintly Shield",          1, 0.3, 1.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_CDR_OHKO:          -5}, ""),
  SAVIOR:    new Artifact("Savior Shield",           1, 0.5, 1.7,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.BOSS_TIME:               10}, ""),
  TINCTURE:  new Artifact("Tincture of the Maker",   1, 0.6, 2.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:   5, BonusTypes.ARTIFACT_DAMAGE_BOOST:    5}, ""),
  UA:        new Artifact("Undead Aura",             1, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.RELICS:                   5}, ""),
  FISSURE:   new Artifact("Universal Fissure",       1, 0.5, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  60, BonusTypes.SKILL_DRN_HERO:          10}, ""),
  WR:        new Artifact("Warrior's Revival",       1, 1.0, 2.2,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.HERO_REVIVE_TIME:        -5}, ""),
  WI:        new Artifact("Worldly Illuminator",     1, 0.6, 3.0,    5, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 150, BonusTypes.NUM_MOBS:              -100}, ""),

  AOS:       new Artifact("Amulet of Storms",        2, 2.0, 6.0,    5, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 300, BonusTypes.NUM_MOBS:              -100}, ""),
  ORB:       new Artifact("Annihilation Orb",        2, 1.0, 1.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  20, BonusTypes.CHEST_ARTIFACTS:         10, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  AO:        new Artifact("Anointment Ointment",     2, 0.5, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 150, BonusTypes.UPGRADE_COST:            -1, BonusTypes.GOLD_OVERALL:            5}, ""),
  BATON:     new Artifact("Aphrodite's Baton",       2, 1.0, 4.0,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.HERO_REVIVE_TIME:        -2, BonusTypes.GOLD_OVERALL:            5}, ""),
  WAND:      new Artifact("Atomic Wand",             2, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.RELICS:                   2, BonusTypes.GOLD_OVERALL:            5}, ""),
  ADS:       new Artifact("Azure Dragon Statuette",  2, 0.5, 1.8, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  20, BonusTypes.GOLD_OVERALL:             5, BonusTypes.SKILL_DRN_TDMG:          5}, ""),
  BOOTS:     new Artifact("Boots of Wilting",        2, 0.3, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 200, BonusTypes.SKILL_CDR_OHKO:          -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   5}, ""),
  BOB:       new Artifact("Braid of Binding",        2, 1.1, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.CHEST_CHANCE:             5, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  CC:        new Artifact("Chilling Chalice",        2, 0.4, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 200, BonusTypes.SKILL_CDR_TDMG:          -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   5}, ""),
  CM:        new Artifact("Circe's Mirror",          2, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.RELICS:                   2, BonusTypes.GOLD_BOSS:              30}, ""),
  CRYSTAL:   new Artifact("Conjuror Crystal",        2, 1.1, 4.0,   12, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 115, BonusTypes.HERO_DEATH_CHANCE:       -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:  10}, ""),
  CANDLE:    new Artifact("Cosmic Candle",           2, 0.6, 2.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:   5, BonusTypes.ARTIFACT_DAMAGE_BOOST:    2, BonusTypes.GOLD_BOSS:              30}, ""),
  CROWN:     new Artifact("Crown of Cleopatra",      2, 0.9, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  25, BonusTypes.GOLD_MOBS:                5, BonusTypes.SKILL_DRN_CRIT:          5}, ""),
  HORNS:     new Artifact("Demon Horns",             2, 0.4, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 200, BonusTypes.SKILL_CDR_HERO:          -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   5}, ""),
  EOV:       new Artifact("Elixir of Verve",         2, 0.5, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_HERO:           5, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  HARP:      new Artifact("Harp of Medea",           2, 0.5, 3.1,   50, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 140, BonusTypes.BOSS_HEALTH:           -0.5, BonusTypes.GOLD_MOBS:               5}, ""),
  HOF:       new Artifact("Horseshoe of Fortune",    2, 0.6, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.TAP_DAMAGE_ARTIFACTS:     1, BonusTypes.CRIT_DAMAGE_ARTIFACTS:  10}, ""),
  STAFF:     new Artifact("Inebriated Staff",        2, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.GOLD_10X_CHANCE:        0.2, BonusTypes.RELICS:                  2}, ""),
  MANGLE:    new Artifact("Mage's Mantle",           2, 0.7, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.GOLD_BOSS:               40, BonusTypes.SKILL_DRN_AUTO:          5}, ""),
  MM:        new Artifact("Magic Mist",              2, 0.5, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_CRIT:           5, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  MARK:      new Artifact("Mark of Dominance",       2, 0.6, 2.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:   5, BonusTypes.ARTIFACT_DAMAGE_BOOST:    2, BonusTypes.SKILL_DRN_GOLD:          5}, ""),
  EARRING:   new Artifact("Mercury's Earring",       2, 0.7, 2.3, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.CRIT_DAMAGE_ARTIFACTS:    5, BonusTypes.SKILL_DRN_HERO:          5}, ""),
  GLOBE:     new Artifact("Merlin's Globe",          2, 0.4, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 200, BonusTypes.SKILL_CDR_AUTO:          -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   5}, ""),
  MOR:       new Artifact("Mirror of Refraction",    2, 0.6, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.TAP_DAMAGE_ARTIFACTS:     1, BonusTypes.GOLD_10X_CHANCE:         1}, ""),
  GOBLET:    new Artifact("Morgana's Goblet",        2, 0.6, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  30, BonusTypes.GOLD_ARTIFACTS:           2, BonusTypes.GOLD_BOSS:              30}, ""),
  NECKLACE:  new Artifact("Necklace of Nether",      2, 0.7, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 200, BonusTypes.SKILL_CDR_GOLD:          -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   5}, ""),
  PMB:       new Artifact("Pandora's Music Box",     2, 0.4, 2.8,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 200, BonusTypes.SKILL_CDR_CRIT:          -2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   5}, ""),
  PETALS:    new Artifact("Petals of Protection",    2, 0.6, 4.0,   12, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 130, BonusTypes.TAP_DAMAGE_ARTIFACTS:     1, BonusTypes.HERO_DEATH_CHANCE:      -2}, ""),
  PR:        new Artifact("Phoenix Renewed",         2, 0.5, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_AUTO:           5, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  RR:        new Artifact("Ra's Ring",               2, 0.7, 1.7, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.GOLD_10X_CHANCE:       0.25, BonusTypes.GOLD_OVERALL:            5}, ""),
  ROF:       new Artifact("Ring of Fire",            2, 0.7, 2.3, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.GOLD_ARTIFACTS:           2, BonusTypes.CRIT_DAMAGE_ARTIFACTS:   2}, ""),
  ROD:       new Artifact("Rod of Great Gales",      2, 0.9, 4.0,   12, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 130, BonusTypes.HERO_DEATH_CHANCE:       -2, BonusTypes.HERO_REVIVE_TIME:      -10}, ""),
  ROPE:      new Artifact("Rope of Lashes",          2, 0.5, 3.3,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS: 125, BonusTypes.GOLD_MOBS:                5, BonusTypes.BOSS_TIME:               5}, ""),
  SCARAB:    new Artifact("Scarab of Insanity",      2, 0.7, 2.0, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.RELICS:                   2, BonusTypes.GOLD_MOBS:               5}, ""),
  SOL:       new Artifact("Scroll of Lightning",     2, 0.8, 3.4,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.CRIT_CHANCE:              1, BonusTypes.GOLD_MOBS:               5}, ""),
  SG:        new Artifact("Shock Gauntlets",         2, 0.5, 2.6,   50, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  85, BonusTypes.BOSS_HEALTH:           -0.5, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  SOS:       new Artifact("Slippers of Sleep",       2, 0.6, 2.5,   10, {BonusTypes.ALL_DAMAGE_ARTIFACTS:   5, BonusTypes.ARTIFACT_DAMAGE_BOOST:    2, BonusTypes.HERO_REVIVE_TIME:       -2}, ""),
  SS:        new Artifact("Swift Swill",             2, 0.5, 2.5, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:   5, BonusTypes.GOLD_BOSS:               30, BonusTypes.CHEST_ARTIFACTS:        10}, ""),
  VIAL:      new Artifact("Vial of Frost",           2, 0.7, 2.1, null, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  35, BonusTypes.SKILL_DRN_GOLD:           5, BonusTypes.GOLD_ARTIFACTS:          2}, ""),
  WOW:       new Artifact("Wand of Wonder",          2, 0.5, 3.4,   25, {BonusTypes.ALL_DAMAGE_ARTIFACTS:  15, BonusTypes.BOSS_TIME:                5, BonusTypes.CRIT_CHANCE:             1}, ""),
};
